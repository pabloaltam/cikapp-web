...
<div class="container">
    ...
    <div class="row">
        ...
        <form class="form-horizontal" role="form" action="" method="post" name="formDatos">
            <!-- edit form column -->
            <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" value="<?php echo $apellido ?>" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-3 control-label">Apellido materno:</label>
                    <div class="col-lg-8">
                        <input class="form-control" value="<?php echo $apellidoM ?>" type="text">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input class="form-control" value="<?php $skype?>" type="text">
                    </div>
                </div>
                <div class="form-group">
